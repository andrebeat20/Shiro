                    ...
                    for (let user of participants) {
                       let pp = './src/welcome.jpg'
                        try {
                            ...
                            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Wahh, Ada Member Baru NIh..').replace('@subject', groupMetadata.subject).replace('@desc', groupMetadata.desc.toString()) :
                                (chat.sBye || this.bye || conn.bye || 'Yahh, Ada Member Keluar Nih Min'))
                                this.sendButtonImg(id, pp, text, "Group Message", "Hi Member Baru 👋", "wkwk", null)
                                }
                    }
                }
                break
